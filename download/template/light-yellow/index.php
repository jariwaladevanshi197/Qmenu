			...
			<div class="row">
				<div class="col-9">
					...
					<a href="index.php<?php echo '?restroid='.$restroid; ?>">
							<h2 style="text-transform:capitalize; color:#00d2ff;"><?php echo "<span>".$name."</span>"; ?></h2>
						</a>
					</div>
				</div>
			...
			<div class="row mb-3 mt-2">
				<div class="col-12 text-center">
					...
					if ($pdf != '') {
						...
						echo '<a href="' . $pdf_rel_path . '" download class="btn btn-warning btn-block shadow-sm text-bold py-2" style="color:#fff;"><i class="fa fa-download mr-1"></i>Download Menu</a>';
					}
					?>
				</div>
			</div>
