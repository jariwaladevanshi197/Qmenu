...
<body>
	...
	<div class="sidebar-panel">
		<ul id="slide-out" class="collapsible side-nav  scrollbar-light-blue">
			...
			<li class="sidemenu active-menu"><a href="addtable.php"><i class="fa fa-map-marker"></i>Add Table</a></li>
	...
	<div class="segments-page menu" id="segments" style="margin-top:0px;">
		<div class="container">
					...
					<div id="accordion">
						<div class="card">
							<div class="card-header" role="tab" id="peterhead" data-toggle="collapse" data-target="#peter">
								<h5 class="mb-0">
									<a>
										<i class="fa fa-table"></i> <span class="category-title">Table List</span> <i class="fa fa-caret-down down-icon"></i>
	...
	<div class="modal fade" id="edittable" tabindex="-1" role="dialog" aria-labelledby="editCategoryLabel" aria-hidden="true">
				...
				<div class="modal-body">
					<div class="col-12 ">
						<form>
							...
							<div class="field">
								<label>Table Name</label>
								<input type="text" id="mytablename">
							</div>
							<div class="fail" id="name_e"></div>
							<div class="" id="taberror"></div>
							<button class="button btn-add z-depth-1" type="button" id="updatetable"><i class="fa fa-pencil"></i>Update</button>
						</form>
					</div>
				</div>
			</div>
