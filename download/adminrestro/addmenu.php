...
<head>
	...
	<title>ADD-MENU-ITEM | ADMIN[RESTRO]</title>
...
<body>
	...
	<div class="sidebar-panel">
		<ul id="slide-out" class="collapsible side-nav  scrollbar-light-blue">
			...
			<li class="sidemenu active-menu "><a href="addmenu.php"><i class="fa fa-plus-square"></i>Add Menu Item</a></li>
			...
			<div class="row">
				...
				<div class="col-12 col-md-8 signin-contents z-depth-1 ">
					...
					<form autocomplete="off">
						...
						<button class="button btn-add z-depth-1" type="button" id="additem"><i class="fa fa-plus"></i>Add Menu Item</button>
					</form>
				</div>
