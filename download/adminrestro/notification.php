...
<body>
    ...
    <div class="sidebar-panel">
        <ul id="slide-out" class="collapsible side-nav  scrollbar-light-blue">
            ...
            <li class="sidemenu active-menu"><a href="notification.php"><i class="fa fa-bullhorn"></i>Waiter Call</a></li>
    ...
    <!-- list -->
    <div class="list segments-page" id="segments" style="margin-top: 50px;">
        <div class="container" id="allcall">
            <!-- <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Table 21</strong>&nbsp; Calling...
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Table 01</strong>&nbsp; Calling...
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Table 05</strong>&nbsp; Calling...
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Table 10</strong>&nbsp; Calling...
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Table 15</strong>&nbsp; Calling...
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div> -->
