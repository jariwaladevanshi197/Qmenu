...
$url = $_POST['url'];
      ...
      //  $target_file =  "../../assets/image/template_tumb/" . $milliseconds . "." . $ext;
      
      //  if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            
      //        $path =  "/project/php admin penel/adminpanel/assets/image/template_tumb/" . $milliseconds . "." . $ext;
      //        $time = date('Y-m-d h:i:s', time());
      $query = "UPDATE theme SET title='$title',url='$url' WHERE id= '$id'";
