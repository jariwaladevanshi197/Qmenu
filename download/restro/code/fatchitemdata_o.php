...
if (isset($_SERVER['HTTP_REFERER'])) {
    ...
    $itemid = $_POST['itemid'];
    $sql = "select name_eng,name_hindi,name_guj,price,image,categoryid,veg from menuitems where restroid = '$restroid' AND id='$itemid' limit 1";
    ...
    if ($row > 0) {
        ...
        $price = $row['price'];
        $image = str_replace('/restro/admin/', '', $row['image']);
