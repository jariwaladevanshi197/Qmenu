...
if (isset($_SERVER['HTTP_REFERER'])) {
  ...
  while ($value = mysqli_fetch_array($result)) {
    ...
    $display_img = 'admin/' . $item_img;
    $imagedefault = "'admin/images/defaultitem.jpg'";
    $image_veg = "";
    if ($value['veg'] == 1) {
      $image_veg = 'admin/images/nonveg.png';
    } elseif ($value['veg'] == 0) {
      $image_veg = 'admin/images/veg.png';
    }
  ...
  <div class="contents z-depth-1 d-flex align-items-center">
    ...
    <img  style="object-fit: cover; 
      object-position: center;
       " src="' . $display_img . '" alt="No Image" onerror="this.onerror=null; this.src=' . $imagedefault . ';"/>
    </div>
