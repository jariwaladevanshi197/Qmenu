...
<body>
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<div class="profile-banner">
									<h6 class="mb-3">Add Menu Item Image</h6>
									<div class="contents">
										<img id="blah" src="images/blog1.jpg" class="imagesize z-depth-1" alt="your image" style="border-radius: 10px; width: 100%; object-fit: cover; height: 200px;">
										<span class="mt-3 text-success d-block"> <strong>Note :</strong> Image upload upto 2MB</span>
                                        
                                        <label for="file-input" class="btn btn-warning btn-block mt-2 z-depth-1">
                                            <i class="fa fa-cloud-upload mr-2"></i> Choose Image
                                        </label>
										<input id="file-input" type="file" name="imageUpload" onchange="readURL(this);" style="display:none;" />
									</div>
							...
							<div class="col-12 col-md-6">
								<div class="input-field mt-3 mt-md-0">
								...
								<div class="fail" id="category_e"></div>

								<div class="" id="error"></div>
								<button class="button btn-warning btn-signup z-depth-1" type="button" id="additem"><i class="fa fa-plus"></i>Add Item</button>
							</div>
						</div>
	...
	<script src="js/addmenuitem.js?v=2"></script>
</body>
