...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-3 pr-0">
          <select class="select-table btn mb-2 btn-primary" id="gst">
            <option value="1">GST</option>
            <option value="0">W/O GST</option>
          </select>

        </div>
        <div class="col-6">
          <button class='btn btn-primary btn-block' id="btncharge" data-toggle="modal" data-target="#setcharge" id="servicecharg" style="font-weight:bolder;">Service Charge</button>
        </div>
      ...
      <div id="merge-container">
          <div id="merge-count">0</div>
          <div class="merge-actions">
              <button class="btn-merge-action btn-merge-active" id="btn-merge-active">
                  <i class="fa fa-object-group"></i> Merge Tables
              </button>
              <button class="btn-merge-action btn-merge-print" id="btn-merge">
                  <i class="fa fa-print"></i> Print
              </button>
              <button class="btn-merge-action btn-merge-complete" id="btn-merge-complete">
      ...
      <div class="collapse">
        ...
        <ul class="collapsible" data-collapsible="accordion" id="ordercontainer">
  ...
  <div class="modal fade" id="setcharge" tabindex="-1" role="dialog" aria-labelledby="setchargeLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="setchargeLabel">
            <i class="fa fa-pencil pr-1"></i> Set Service Charge
          </h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
          ...
          <div class="">
            <form>
              ...
              <div class="field">
                ...
                <input type="number" id="servicecharge" min="0" max="10" autofocus placeholder="Example : From 1 to 10 ">
              </div>
              <div class="fail" id="service_e"></div>
              <div class="" id="serviceerror"></div>
              <button class="button-full btn-warning z-depth-1" type="button" id="updatecharge">
                <i class="fa fa-pencil"></i>Service Charge
              </button>
            </form>
          </div>
        </div>
